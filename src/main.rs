...
const OPTION_COUNT: usize = 11; // Increased for Save option
...
const SAVE_OPTION_IDX: usize = 9; // New option
...
struct App {
    ...
    info_message: Option<String>, // For showing feedback
}
...
impl App {
    ...
    /// Generates `monitor=` lines and saves them to a file.
    ...
    fn handle_key(&mut self, code: KeyCode) -> bool {
        // Clear previous message on any new key press
...
fn render_instructions(f: &mut Frame, app: &App, area: Rect) {
    ...
    // FIX: Changed Color.Yellow to Color::Yellow
